...
%             block_min = min([floor(a(1,1)/8)*8 floor(a(2,1)/8)*8 floor(a(3,1)/8)*8 floor(a(4,1)/8)*8]);
            ...
            block_max = max([floor(a(1,1)/4)*4 floor(a(2,1)/4)*4 floor(a(3,1)/4)*4 floor(a(4,1)/4)*4]);
            block_min = min([floor(a(1,1)/4)*4 floor(a(2,1)/4)*4 floor(a(3,1)/4)*4 floor(a(4,1)/4)*4]);
            k = 0;
            distance = [];
            for pixel_traverse = block_min : 4 : block_max
                k=k+1;
...
%             average_value = mean(a(:));
%             watermark_data(i,j) = average_value;
        end
    end
